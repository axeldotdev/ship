...
class Agent extends MobileDetect
{
    ...
    {
        return $this->retrieveUsingCacheOrResolve('jetstream.platform', fn () => $this->findDetectionRulesAgainstUserAgent(
    ...
    {
        return $this->retrieveUsingCacheOrResolve('jetstream.browser', fn () => $this->findDetectionRulesAgainstUserAgent(
